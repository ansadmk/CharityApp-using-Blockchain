...
public class customImage extends BaseAdapter {
    ...
    public customImage(Context applicationContext, ArrayList<String> a, ArrayList<String> b,ArrayList<String> c,ArrayList<String> d) {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        try {
            ...
            thumb_u = new java.net.URL("http://"+sh.getString("ip","")+":5000/static/photos/"+a.get(position));
