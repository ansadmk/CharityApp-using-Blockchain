...
public class ViewRequest extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = "http://" + sh.getString("ip", "") + ":5000/viewrequestofcharity";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    l1.setAdapter(new customforRequests(ViewRequest.this, Name, contact, request, date));
...
//
                                            Toast.makeText(ViewRequest.this, "Accepted", Toast.LENGTH_SHORT).show();
                                            ...
                                            Toast.makeText(ViewRequest.this, "Error", Toast.LENGTH_SHORT).show();
                        ...
                        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                try {
                                    ...
                                    if (res.equalsIgnoreCase("valid")) {
//
                                        Toast.makeText(ViewRequest.this, "Rejected", Toast.LENGTH_SHORT).show();
